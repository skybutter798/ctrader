                            ...
                            <tbody>
                                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($task->status == 'Pending'): ?>
                                                <a class="btn btn-success btn-sm m-1 text-white" data-toggle="modal"
                                                    ...
                                                    <form method="post" action="<?php echo e(route('updatetask')); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <div class=" ">
                                                                ...
                                                                <input type="text" name="tasktitle"
                                                                    value="<?php echo e($task->title); ?>" class="form-control  "
                                                                    required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <h5 class=" ">To</h5>
                                                                    <input type="date" value="<?php echo e($task->end_date); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/assetsplus/trade/resources/views/admin/mtask.blade.php ENDPATH**/ ?>