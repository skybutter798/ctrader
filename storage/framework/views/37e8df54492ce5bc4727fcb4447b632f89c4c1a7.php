...
} elseif ($_instance->childHasBeenRendered('LnIy28l')) {
    $componentId = $_instance->getRenderedChildComponentId('LnIy28l');
    $componentTag = $_instance->getRenderedChildComponentTagName('LnIy28l');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LnIy28l');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('LnIy28l', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/assetsplus/trade/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>