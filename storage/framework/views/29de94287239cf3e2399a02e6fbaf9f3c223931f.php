                                ...
                                <div class="p-1 col-md-4">
                                    <div class="card border p-1 ">
                                        <div class="card-body">
                                            ...
                                            <a href="<?php echo e(url('admin/dashboard/delfaq')); ?>/<?php echo e($faq->id); ?>" type="button"
                                                data-toggle="tooltip" title="" class="btn btn-sm btn-danger"
                                                data-original-title="Remove"><i class="fa fa-times"></i></a> &nbsp;
                                            <a href="#" data-toggle="modal" data-target="#editfaq<?php echo e($faq->id); ?>"
                                            ...
                                            <div class="modal-body ">
                                                <form action="<?php echo e(route('updatefaq')); ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="question" value="<?php echo e($faq->question); ?>"
                                                ...
                                                <form action="<?php echo e(route('updatetestimony')); ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="testifier" placeholder="Full name"
                                                            value="<?php echo e($faq->name); ?>" class="form-control  ">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <form action="<?php echo e(route('updatecontents')); ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title"
                                                            placeholder="Name of Content" value="<?php echo e($faq->title); ?> "
                                                ...
                                                <form action="<?php echo e(route('updateimg')); ?>" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="img_title"
                                                            value="<?php echo e($faq->title); ?>" placeholder="Name of Image"
                                                            class="form-control  ">
                                                    </div>
                                                    <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/assetsplus/trade/resources/views/admin/Settings/FrontendSettings/frontpage.blade.php ENDPATH**/ ?>