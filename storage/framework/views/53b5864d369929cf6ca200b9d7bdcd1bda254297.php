...
} elseif ($_instance->childHasBeenRendered('2f01czn')) {
    $componentId = $_instance->getRenderedChildComponentId('2f01czn');
    $componentTag = $_instance->getRenderedChildComponentTagName('2f01czn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2f01czn');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('2f01czn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/assetsplus/trade/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>