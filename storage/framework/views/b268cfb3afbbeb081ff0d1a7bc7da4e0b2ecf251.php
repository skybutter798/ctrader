...
} elseif ($_instance->childHasBeenRendered('fVnacFa')) {
    $componentId = $_instance->getRenderedChildComponentId('fVnacFa');
    $componentTag = $_instance->getRenderedChildComponentTagName('fVnacFa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fVnacFa');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('fVnacFa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <?php if((!empty($payment_mode->barcode) or $payment_mode->barcode != null) and $payment_mode->methodtype != 'currency'): ?>
                                                    <div class="text-center">
                                                        <img src="<?php echo e(asset('storage/app/public/' . $payment_mode->barcode)); ?>"
                                                            alt="" class="w-50">
                                                    </div>
                                                <?php endif; ?>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/assetsplus/trade/resources/views/user/payment.blade.php ENDPATH**/ ?>